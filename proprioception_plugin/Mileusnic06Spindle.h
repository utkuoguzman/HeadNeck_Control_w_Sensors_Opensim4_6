...
class  Mileusnic06Spindle : public ModelComponent {OpenSim_DECLARE_CONCRETE_OBJECT(Mileusnic06Spindle, ModelComponent);
...
//=============================================================================
	...
	OpenSim_DECLARE_OUTPUT(secondary_II, double, getIIOutput, SimTK::Stage::Dynamics);

	//inputs
	OpenSim_DECLARE_INPUT(dynamic_gamma, double, SimTK::Stage::Dynamics, "Dynamic gamma motoneuron input (pulses/s)");
	OpenSim_DECLARE_INPUT(static_gamma, double, SimTK::Stage::Dynamics, "Static gamma motoneuron input (pulses/s)");
