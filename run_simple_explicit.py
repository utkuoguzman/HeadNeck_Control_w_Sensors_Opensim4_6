...
log_file = os.path.join(script_dir, 'logs', 'log_simple_explicit.txt')
model_file = os.path.join(script_dir, 'osim_files', 'HYOID_HeadNeckNeural_Model_WithLimits.osim')
method = 3
save_path = os.path.join(script_dir, 'state_files', 'simple_explicit.sto')
